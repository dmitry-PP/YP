...
SELECT ID, Title, Pages, Price, DateRelease, Amount, Author_ID FROM Books WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"select Books.ID,Books.Title, Books.Pages, Books.Price, Books.DateRelease, Books.Amount, Books.Author_ID,
Authors.ID,Authors.FirstName, Authors.LastName, Authors.SureName, Authors.Birthday, Authors.Nationality from Books
left join Authors on Books.Author_ID = Authors.ID;";
        ...
        public virtual DataSetLib.BooksDataTable GetDataBy() {
