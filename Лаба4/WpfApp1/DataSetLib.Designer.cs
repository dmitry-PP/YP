            ...
            public int Amount {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Amount\' в таблице \'Books\' равно DBNull.", e);
                    }
                }
                set {
...
namespace WpfApp1.DataSetLibTableAdapters {
    ...
    public partial class AuthorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Authors] WHERE (([ID] = @Original_ID) AND ([SureName] = @Original_SureName) AND ([FirstName] = @Original_FirstName) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ([Birthday] = @Original_Birthday) AND ([Nationality] = @Original_Nationality))";
...
SELECT ID, SureName, FirstName, LastName, Birthday, Nationality FROM Authors WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ID, SureName, FirstName, LastName, Birthday, Nationality FROM dbo.Authors " +
                "WHERE Nationality = @Nationality;";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Nationality", global::System.Data.SqlDbType.VarChar, 25, global::System.Data.ParameterDirection.Input, 0, 0, "Nationality", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT ID, SureName, FirstName, LastName, Birthday, Nationality FROM dbo.Authors " +
                "WHERE SureName LIKE \'%\'+@toSearch+\'%\';";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@toSearch", global::System.Data.SqlDbType.VarChar, 25, global::System.Data.ParameterDirection.Input, 0, 0, "SureName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual DataSetLib.AuthorsDataTable FilterByNationality(string Nationality) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSetLib.AuthorsDataTable SearchBySureName(string toSearch) {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Books] WHERE (([ID] = @Original_ID) AND ([Title] = @Original_Title) AND ([Pages] = @Original_Pages) AND ([Price] = @Original_Price) AND ([DateRelease] = @Original_DateRelease) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)) AND ([Author_ID] = @Original_Author_ID))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
...
SELECT ID, Title, Pages, Price, DateRelease, Amount, Author_ID FROM Books WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT ID, Title, Pages, Price, DateRelease, Amount, Author_ID FROM dbo.Books WHE" +
                "RE Author_ID = @AuthorID;";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@AuthorID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Author_ID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT ID, Title, Pages, Price, DateRelease, Amount, Author_ID FROM dbo.Books WHE" +
                "RE Title LIKE \'%\'+@toSearch+\'%\';";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSetLib.BooksDataTable FilterByAuthor(int AuthorID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSetLib.BooksDataTable SearchByTitle(string toSearch) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((toSearch == null)) {
                throw new global::System.ArgumentNullException("toSearch");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_ID, string Original_Title, int Original_Pages, int Original_Price, System.DateTime Original_DateRelease, global::System.Nullable<int> Original_Amount, int Original_Author_ID) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_ID));
            ...
            this.Adapter.DeleteCommand.Parameters[7].Value = ((int)(Original_Author_ID));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.DeleteCommand.Connection.State;
            if (((this.Adapter.DeleteCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.DeleteCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Title, int Pages, int Price, System.DateTime DateRelease, global::System.Nullable<int> Amount, int Author_ID) {
            if ((Title == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, int Pages, int Price, System.DateTime DateRelease, global::System.Nullable<int> Amount, int Author_ID, int Original_ID, string Original_Title, int Original_Pages, int Original_Price, System.DateTime Original_DateRelease, global::System.Nullable<int> Original_Amount, int Original_Author_ID, int ID) {
            if ((Title == null)) {
                throw new global::System.ArgumentNullException("Title");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_Author_ID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, int Pages, int Price, System.DateTime DateRelease, global::System.Nullable<int> Amount, int Author_ID, int Original_ID, string Original_Title, int Original_Pages, int Original_Price, System.DateTime Original_DateRelease, global::System.Nullable<int> Original_Amount, int Original_Author_ID) {
